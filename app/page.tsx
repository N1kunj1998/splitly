    ...
    <div className='flex flex-col pt-16'>
      <section className='mt-20 pb-12 space-y-10 md:space-y-20 px - 5'>
        <div className='container mx-auto px-4 md:px-6 text-center space-y-6'>
          ...
          <h1 className='gradient-title mx-auto max-w-4xl text-4xl md:text-7xl'>
            The Smartest way to split expenses with firends
          </h1>

          <p className='mx-auto mx-w-[700px] text-gray-500 md:text-xl/relaxed'>
            Track share expenses, split bills effortlessly, and  settle up quickly. Never worry about who owes again
          </p>
          ...
          <div className='flex flex-col sm:flex-row items-center justify-center gap-4'>
            ...
            >
              <Link href={"/dashboard"}>
                Get Started
                <ArrowRight className='ml-2 h4 w-4' />
              </Link>
            </Button>
            <Button
              asChild
        ...
        <div className='container mx-auto mx-w-5xl overflow-hidden rounded-xl shadow-xl'>
      ...
      <section id='features' className='bg-gray-50 py-20'>
        <div className='container mx-auto px-4 md:px-6 text-center'>
          ...
          <div className='mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-2 lg:grid-col-3'>
            {
